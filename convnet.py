...
class UNet(nn.Module):
    ...
    def __init__(self, in_ch, out_ch):
        ...
        # 逆卷积
        self.up6 = nn.ConvTranspose2d(1024, 512, 2, stride=2)#enlarge the image size
    ...
    def __init__(self, in_ch, out_ch):
        ...
        # 逆卷积
        self.up6 = nn.ConvTranspose2d(512, 256, 2, stride=2)#enlarge the image size
        #self.conv6 = DoubleConv(1024, 512)
